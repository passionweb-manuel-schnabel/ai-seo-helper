...
class SelectedModelFactory
{
    ...
    {
        return  $extConf['openAiModel'] === 'gpt-3.5-turbo-16k-0613' ||
                $extConf['openAiModel'] === 'gpt-3.5-turbo-0613' ||
                $extConf['openAiModel'] === 'gpt-3.5-turbo-16k' ||
                $extConf['openAiModel'] === 'gpt-3.5-turbo-instruct' ||
                ...
                $extConf['openAiModel'] === 'gpt-4-vision-preview' ||
